...
def init_he1(self, line):
    ...
    # Start MIP daemons on each host
    ...
    terms.append(openTerm(self,
                          ...
                          cmd="./ping_client /tmp/unix.sock 20 \"Hello IN3230\""))

    terms.append(openTerm(self,
                          node=C,
                          title="Client [C]",
                          geometry="80x20+0+600",
                          cmd="./ping_client /tmp/unix.sock 20 \"Hello IN4230\""))

    # This MUST output 'ping timeout' since A is not able to reach C directly.
    terms.append(openTerm(self,
                          node=A,
                          title="Client [A]",
                          geometry="80x20+0+300",
                          cmd="./ping_client /tmp/unix.sock 30 \"Hello IN4230\""))
    ...
    terms.append(openTerm(self,
                          ...
                          title="Client [A]",
                          geometry="80x20+0+300",
                          cmd="./ping_client /tmp/unix.sock 20 \"Hello again IN4230\""))
